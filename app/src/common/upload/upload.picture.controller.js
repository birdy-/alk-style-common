...
var module = angular.module('jDashboardFluxApp');

module.controller("mediaController", [
    "$scope", "$modal", "$log",
    function($scope, $modal, $log) {
        ...
        $scope.uploadNewAd = function(adGroup) {
            ...
            var uploadModal = $modal.open({
              templateUrl: 'src/common/upload/upload-picture.html',
              scope : $scope,
              backdrop : 'static',
...
(function(){
  ...
  module.controller('uploadMediaController', [
    '$scope', '$modalInstance', '$document', '$log',
    function($scope, $modalInstance, $document, $log) {
